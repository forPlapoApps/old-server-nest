...
describe('RoomsController', () => {
  ...
  describe("index", () => {
    it('should return an array of rooms', async () => {
      const result = [{ id: "myFirstRoomId", name: 'room1' }, { id: "mySecondRoomId", name: 'room2' }];
      jest.spyOn(service, 'findAllRooms').mockImplementation(() => Promise.resolve(result));
  ...
  describe("show", () => {
    it('should return an object of room', async () => {
      ...
      jest.spyOn(service, 'findRoom').mockImplementation(() => Promise.resolve(result));
